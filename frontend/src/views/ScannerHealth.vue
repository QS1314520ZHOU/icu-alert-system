...
.scanner-health-filter,.scanner-health-panel { border: 1px solid rgba(80,199,255,.12); background: #FFFFFF; }
...
.scanner-health-notice { padding: 10px 12px; border-radius: 4px; border: 1px solid rgba(251,191,36,.22); background: rgba(66,46,9,.42); color: #E8901C; font-size: 12px; }
...
.quality-list button { display: grid; gap: 4px; width: 100%; text-align: left; border: 1px solid rgba(125,167,214,.14); border-radius: 4px; background: rgba(8,28,44,.64); color: #dff8ff; padding: 9px 10px; }
.quality-list strong { color: #1D2129; font-size: 12px; }
.quality-list span { color: #8aa4b8; font-size: 11px; }
.scanner-health-kpi { padding: 16px; border-radius: 4px; border: 1px solid rgba(125,211,252,.14); background: #FFFFFF; }
...
.scanner-command-card { min-width: 0; padding: 16px; border-radius: 4px; border: 1px solid rgba(125,211,252,.14); background: #FFFFFF; }
...
.scanner-light { display: grid; gap: 4px; min-height: 58px; padding: 8px; border: 1px solid rgba(52,211,153,.22); border-radius: 4px; color: #d1fae5; background: rgba(20,83,45,.18); cursor: pointer; }
.scanner-light.is-yellow { border-color: rgba(251,191,36,.28); color: #E8901C; background: rgba(82,48,12,.22); }
.scanner-light.is-red { border-color: rgba(251,113,133,.34); color: #D9342B; background: rgba(69,10,10,.28); }
...
.scanner-task { display: grid; gap: 4px; padding: 10px; border: 1px solid rgba(125,211,252,.14); border-radius: 4px; color: inherit; background: rgba(2,8,20,.28); text-align: left; cursor: pointer; }
...
.scanner-empty { min-height: 110px; display: grid; place-content: center; border: 1px dashed rgba(125,211,252,.16); border-radius: 4px; }
.scanner-focus { display: grid; gap: 10px; }
.scanner-focus div { display: flex; justify-content: space-between; gap: 12px; padding: 9px 10px; border-radius: 4px; background: rgba(2,8,20,.28); }
.scanner-focus span { color: #8cb7c9; }
.scanner-focus b { color: #ecfeff; }
.scanner-focus p { margin: 0; color: #4E5969; line-height: 1.55; }
.runtime-error { color: #D9342B !important; }
...
.review-tag { padding: 2px 8px; border-radius: 999px; color: #D9342B; border: 1px solid rgba(251,113,133,.28); background: rgba(69,10,10,.38); font-size: 11px; }
...
.drift-pill.is-yellow { border-color: rgba(251,191,36,.28); color: #E8901C; }
.drift-pill.is-red { border-color: rgba(251,113,133,.28); color: #D9342B; }
.drift-pill.is-unknown { border-color: rgba(148,163,184,.24); color: #E5E6EB; }
...
html[data-theme='light'] .scanner-health-page { color: #1D2129; }
...
html[data-theme='light'] .quality-list span { color: #4E5969; }
...
html[data-theme='light'] .scanner-focus p { color: #1D2129; }
...
html[data-theme='light'] .drift-pill.is-yellow { color: #b45309; background: #FFFFFF; }
html[data-theme='light'] .drift-pill.is-red { color: #be123c; background: #FFFFFF; }
