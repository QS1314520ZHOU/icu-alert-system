...
html[data-theme='light'] .evidence-panel--overview { background: #FFFFFF; }
...
html[data-theme='light'] .evidence-chip--accent { background: rgba(59,130,246,0.1); color: #15558D; }
html[data-theme='light'] .evidence-chip--warn { background: rgba(254,243,199,0.96); border-color: rgba(245,158,11,0.28); color: #b45309; }
html[data-theme='light'] .meta-label { color: #15558D; }
