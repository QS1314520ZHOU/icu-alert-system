...
.workbench-kicker,.ops-kicker { color: #6ee7f9; font-size: 11px; letter-spacing: 0.2em; text-transform: uppercase; }
...
.topic-card-main,.ops-main { margin-top: 10px; color: #e8fbff; font-size: 14px; line-height: 1.55; }
...
.topic-chip,.ops-chip,.ops-bullet { padding: 6px 10px; border-radius: 999px; border: 1px solid rgba(125, 211, 252, 0.14); color: #d8f5ff; background: rgba(13, 35, 54, 0.92); font-size: 12px; }
...
.ops-link { margin-top: 14px; border: none; background: transparent; color: #7dd3fc; cursor: pointer; padding: 0; font-size: 13px; }
