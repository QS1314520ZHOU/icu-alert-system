 ...
 * 统一 API 模块
 *
 * 所有 axios 实例和认证逻辑统一由 ./http.ts 管理。
 * 本模块只导出业务 API 函数，不再维护独立的 axios 实例。
 */
import axios from 'axios'
import api, { analyticsApi, researchApi, bundleApi, alertsApi, aiApi } from './http'

// Re-export http module exports for consumers that import from './index'
export { analyticsApi, researchApi, bundleApi, alertsApi, aiApi, setTokenProvider } from './http'
