...
const routeComponents = {
  ...
  diseaseCenterCases: () => import('../views/disease-center/DiseaseCenterCases.vue'),
  ...
  diseaseWorkbench: () => import('../views/disease-center/DiseaseWorkbench.vue'),
  caseDetail: () => import('../views/disease-center/CaseDetail.vue'),
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'cases',
          name: 'disease-center-cases',
          component: routeComponents.diseaseCenterCases,
          meta: { title: '病例中心', useAntdTheme: true, navigationMode: 'global' },
        },
        {
          path: 'cases/:caseId',
          name: 'disease-center-case-detail',
          component: routeComponents.caseDetail,
          meta: { title: '病例详情', useAntdTheme: true, navigationMode: 'global', hidden: true },
        },
        {
          path: 'diseases/:id/workbench',
          name: 'disease-workbench',
          component: routeComponents.diseaseWorkbench,
          meta: { title: '病种工作台', useAntdTheme: true, navigationMode: 'global', hidden: true },
        },
        {
          path: 'terminology',
