...
DEFAULT_FIELD_MAPPINGS = [
    ...
    {"source_name": "bGATemp", "source_code": "param_bg_P/Fratio", "standard_concept": "pf_ratio", "unit": "", "module": "respiratory", "enabled": True, "description": "血气氧合指数 P/F"},
    {"source_name": "bGATemp", "source_code": "param_bg_po2", "standard_concept": "pao2", "unit": "mmHg", "module": "respiratory", "enabled": True, "description": "血气 PO2"},
    {"source_name": "bGATemp", "source_code": "param_bg_po2_T", "standard_concept": "pao2", "unit": "mmHg", "module": "respiratory", "enabled": True, "description": "血气温度校正 PO2"},
    {"source_name": "deviceCap", "source_code": "param_PF", "standard_concept": "pf_ratio", "unit": "", "module": "respiratory", "enabled": True, "description": "氧合指数 P/F"},
    {"source_name": "deviceCap", "source_code": "param_p_f_ratio", "standard_concept": "pf_ratio", "unit": "", "module": "respiratory", "enabled": True, "description": "氧合指数 P/F 备用字段"},
    {"source_name": "deviceCap", "source_code": "param_PaO2", "standard_concept": "pao2", "unit": "mmHg", "module": "respiratory", "enabled": True, "description": "动脉氧分压"},
    {"source_name": "bedside", "source_code": "param_pao2", "standard_concept": "pao2", "unit": "mmHg", "module": "respiratory", "enabled": True, "description": "动脉氧分压备用字段"},
    {"source_name": "deviceCap", "source_code": "param_ETCO2", "standard_concept": "etco2", "unit": "mmHg", "module": "respiratory", "enabled": True, "description": "呼气末二氧化碳"},
    {"source_name": "bedside", "source_code": "param_etco2", "standard_concept": "etco2", "unit": "mmHg", "module": "respiratory", "enabled": True, "description": "呼气末二氧化碳备用字段"},
    {"source_name": "deviceCap", "source_code": "param_EE", "standard_concept": "energy_expenditure", "unit": "kcal/day", "module": "respiratory", "enabled": True, "description": "间接测热法能量消耗 EE"},
    {"source_name": "deviceCap", "source_code": "param_indirect_calorimetry_ee", "standard_concept": "energy_expenditure", "unit": "kcal/day", "module": "respiratory", "enabled": True, "description": "间接测热法 EE 备用字段"},
